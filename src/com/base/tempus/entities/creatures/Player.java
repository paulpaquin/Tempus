package com.base.tempus.entities.creatures;
...
import com.base.tempus.entities.Entity;
import com.base.tempus.gfx.Animation;
import com.base.tempus.gfx.Assets;
import com.base.tempus.inventory.Inventory;
...
//		animRight.tick();
		...
		if(y>64*29 && !hasDisplayed) {
			handler.getWorld().getDialogue().setDialogue("Finally out!");
			hasDisplayed = true;
		}
	}
