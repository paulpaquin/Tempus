...
public class Assets {
	...
	public static BufferedImage[] wallBroken, door, doorLocked, wallSmallHole, heartAltar;
	public static BufferedImage wood, timeHeart, key;
	...
	public static void init() {
		...
		door[0] = textures.crop(0, height*3, width, height);
		door[1] = textures.crop(width, height*3, width, height);
		
		doorLocked = new BufferedImage[2];
		doorLocked[0] = textures.crop(width*5, height*4, width, height);
		doorLocked[1] = door[1];
		...
		key = textures.crop(width*3, height*4, width, height);
		...
		grass = textures.crop(width*6, height*4, width, height);
