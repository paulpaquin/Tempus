package com.base.tempus.inventory;
...
import com.base.tempus.gfx.Text;
...
//		addItem(Item.createNew(5, Item.key));
//		addItem(Item.createNew(1, Item.timeHeart));
...
//				item.setCount(i.getCount());
				if(i.getCount() <= 0) {
					i.setCount(0);
					inventoryItems.remove(inventoryItems.indexOf(item));
				}
				return;
			}
		}
